...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.Chip$$ExternalSyntheticLambda3
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                this.f$0.m194lambda$new$0$comgoogleandroidmaterialchipChip(compoundButton, z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$com-google-android-material-chip-Chip, reason: not valid java name */
    /* synthetic */ void m194lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton compoundButton, boolean z) {
