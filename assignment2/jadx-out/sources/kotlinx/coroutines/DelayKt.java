...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1896scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1833delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1834toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1834toDelayMillisLRDsOJo(long j) {
        if (Duration.m1669compareToLRDsOJo(j, Duration.INSTANCE.m1772getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1688getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
