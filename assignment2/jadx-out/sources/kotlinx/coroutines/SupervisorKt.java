...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m1839SupervisorJob(Job job) {
        return SupervisorJob(job);
    }

    /* JADX INFO: renamed from: SupervisorJob$default, reason: collision with other method in class */
    public static /* synthetic */ Job m1840SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m1839SupervisorJob(job);
    }
