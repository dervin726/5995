    ...
    */
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation<Unit> continuation : continuationArrFindSlotsToResumeLocked) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m299constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m299constructorimpl(Unit.INSTANCE));
        ...
        for (Continuation<Unit> continuation2 : continuationArrFindSlotsToResumeLocked) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m299constructorimpl(Unit.INSTANCE));
            }
        }
