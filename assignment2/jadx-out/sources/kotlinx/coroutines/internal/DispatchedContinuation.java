...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context2)) {
            ...
            this.resumeMode = 0;
            this.dispatcher.mo1895dispatch(context2, this);
            return;
        }
    ...
    */
    ...
    public final boolean resumeCancelled(Object state) {
        ...
        resumeWith(Result.m299constructorimpl(ResultKt.createFailure(cancellationException)));
        return true;
    }
