...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1896scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1896scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
    ...
    public void mo1895dispatch(CoroutineContext context, Runnable block) {
        if (addAndTryDispatching(block) || !tryAllocateWorker()) {
            return;
        }
        this.dispatcher.mo1895dispatch(this, this);
    }
