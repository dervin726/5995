...
public interface ReceiveChannel<E> {
    ...
    Object mo1847receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1848tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1848tryReceivePtdJZtk = receiveChannel.mo1848tryReceivePtdJZtk();
            if (ChannelResult.m1864isSuccessimpl(objMo1848tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1860getOrThrowimpl(objMo1848tryReceivePtdJZtk);
            }
            Throwable thM1858exceptionOrNullimpl = ChannelResult.m1858exceptionOrNullimpl(objMo1848tryReceivePtdJZtk);
            if (thM1858exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1858exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1847receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1859getOrNullimpl(r4)
                return r4
            */
