...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo1847receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            java.lang.Object r5 = r0.m1867closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            java.lang.Object r5 = r0.m1869successJP2dKIU(r5)
        L52:
            return r5
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1847receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public final Object mo1848tryReceivePtdJZtk() {
        Object objPollInternal = pollInternal();
        return objPollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1868failurePtdJZtk() : objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m1867closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m1869successJP2dKIU(objPollInternal);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object objM1886constructorimpl$default = InlineList.m1886constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1894remove()) {
                    prevNode.helpRemove();
                } else {
                    objM1886constructorimpl$default = InlineList.m1891plusFjFbRPM(objM1886constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1846onCancelIdempotentListww6eGU(objM1886constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) throws Throwable {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1854boximpl(z ? companion.m1867closedJP2dKIU(((Closed) obj).closeCause) : companion.m1869successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1854boximpl(ChannelResult.INSTANCE.m1867closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
            ...
            while (true) {
                ...
                if (objPollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m299constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m299constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1854boximpl(ChannelResult.INSTANCE.m1869successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m299constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                ChannelResult channelResultM1854boximpl = ChannelResult.m1854boximpl(ChannelResult.INSTANCE.m1867closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m299constructorimpl(channelResultM1854boximpl));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1854boximpl(ChannelResult.INSTANCE.m1869successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) throws Throwable {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1854boximpl(ChannelResult.INSTANCE.m1867closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo1846onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
