    ...
    */
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            StringBuilder sb = new StringBuilder("");
            Double.isNaN((fMin2 * 100.0f) / Math.abs(f3 - f));
            ...
            StringBuilder sb2 = new StringBuilder("");
            Double.isNaN((fMax2 * 100.0f) / Math.abs(f4 - f2));
    ...
    /* JADX WARN: Removed duplicated region for block: B:62:0x00e4 A[PHI: r5
  0x00e4: PHI (r5v36 float) = (r5v35 float), (r5v37 float), (r5v37 float) binds: [B:47:0x00ae, B:58:0x00d8, B:60:0x00dc] A[DONT_GENERATE, DONT_INLINE]] */
