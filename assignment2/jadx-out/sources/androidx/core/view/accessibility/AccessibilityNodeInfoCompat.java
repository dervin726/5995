...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public int getId() {
            if (Build.VERSION.SDK_INT >= 21) {
                return Trace$$ExternalSyntheticApiModelOutline0.m170m(this.mAction).getId();
            }
            return 0;
        }
        ...
        public CharSequence getLabel() {
            if (Build.VERSION.SDK_INT >= 21) {
                return Trace$$ExternalSyntheticApiModelOutline0.m170m(this.mAction).getLabel();
            }
            return null;
        }
    ...
    public void addAction(AccessibilityActionCompat accessibilityActionCompat) {
        if (Build.VERSION.SDK_INT >= 21) {
            this.mInfo.addAction(Trace$$ExternalSyntheticApiModelOutline0.m170m(accessibilityActionCompat.mAction));
        }
    }

    public boolean removeAction(AccessibilityActionCompat accessibilityActionCompat) {
        if (Build.VERSION.SDK_INT >= 21) {
            return this.mInfo.removeAction(Trace$$ExternalSyntheticApiModelOutline0.m170m(accessibilityActionCompat.mAction));
        }
        return false;
    }
