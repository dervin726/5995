...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(ComponentDialog$$ExternalSyntheticApiModelOutline0.m18m().getName())) {
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2(parcelable)) {
                return IconCompat.createFromIcon(ComponentDialog$$ExternalSyntheticApiModelOutline0.m10m((Object) parcelable));
            }
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m7m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(ComponentDialog$$ExternalSyntheticApiModelOutline0.m10m((Object) bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            android.app.RemoteInput remoteInputM8m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m8m((Object) bundle.getParcelable(KEY_REMOTE_INPUT));
            String[] stringArray = bundle.getStringArray(KEY_PARTICIPANTS);
            if (stringArray == null || stringArray.length != 1) {
                return null;
            }
            if (remoteInputM8m != null) {
                remoteInput = new RemoteInput(Api20Impl.getResultKey(remoteInputM8m), Api20Impl.getLabel(remoteInputM8m), Api20Impl.getChoices(remoteInputM8m), Api20Impl.getAllowFreeFormInput(remoteInputM8m), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInputM8m) : 0, Api20Impl.getExtras(remoteInputM8m), null);
            }
